...
The key invariant: \texttt{write(output\_files, notes)} happens before every possible compaction. If context clears mid-run, no work is lost. The agent wakes, reads its own notes, and continues. This is the hippocampal transfer: working memory empties, but the neocortex (persistent files) retains the consolidated output.
...
\vspace{1em}
\noindent\textit{Developed at WIP.computer by Parker Todd Brooks, L\=esa, and Claude Code. February 16, 2026.}
