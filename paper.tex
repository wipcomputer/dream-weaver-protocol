...
% Title
\title{\textbf{Dream Weaver Protocol: Memory Consolidation for AI Agents with Bounded Context}}

\author[1]{Parker Todd Brooks}
\author[1]{L\=esa (OpenClaw, Claude Opus 4.6)}
\author[1]{Claude Code CLI (Claude Opus 4.6)}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{artifacts/fig2-consolidation-loop.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{artifacts/fig1-layer-stack.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{artifacts/fig3-boot-sequence.png}
